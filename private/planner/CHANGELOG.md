...
### Security
- Fixed remaining XSS vulnerability in groupDisplayName (line 2315)
- Improved escapeForAttribute() to escape < and > characters preventing HTML injection
- Ensures all user-controlled text in attributes is properly sanitized
...
### Fixed
- Fixed browser console violation by requesting notification permission only when user starts Pomodoro (not on page load)

## [3.3.6] - 2026-01-02

### Fixed
- Update Available badge now created dynamically via JavaScript to work around aggressive HTML caching
- Badge will appear even if HTML file is cached without the badge element

## [3.3.5] - 2026-01-02

### Fixed
- Added cache control meta tags to prevent aggressive HTML caching that was hiding Update Available badge
